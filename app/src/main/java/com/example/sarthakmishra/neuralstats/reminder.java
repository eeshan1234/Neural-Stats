    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       public void onResume()
        ...
        public void onAddAlarmClick(View view)
        {
            ...
            reminder.this.startActivityForResult(intent, NEW_ALARM_ACTIVITY);
        }
        ...
        public boolean onCreateOptionsMenu(Menu menu)
        {
            ...
            menuInflater.inflate(R.menu.menualarm, menu);
            return true;
        }
        ...
        private AdapterView.OnItemClickListener mListOnItemClickListener = new AdapterView.OnItemClickListener()
        {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                mCurrentAlarm.toIntent(intent);
                reminder.this.startActivityForResult(intent, EDIT_ALARM_ACTIVITY);
            }
        };
