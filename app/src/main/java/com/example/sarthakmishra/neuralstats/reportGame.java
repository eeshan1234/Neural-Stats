...
public class reportGame extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportGame.MyPlayerStateChangeListener playerStateChangeListener;
    private reportGame.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportGame.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportGame.this,MapsActivity.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0) {
                    Toast.makeText(reportGame.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//                barentries.add(new BarEntry(50f, 5));
                ...
                barentries.add(new BarEntry(Gamescore, 0));
                barentries.add(new BarEntry(50f, 1));
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(Gamescore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (Gamescore >= 0 && Gamescore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeGA(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionGA(0));

                } else if (Gamescore >= 25 && Gamescore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeGA(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionGA(1));
                } else if (Gamescore >= 50 && Gamescore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeGA(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionGA(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeGA(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionGA(3));
...
//videos
        ...
        playerStateChangeListener = new reportGame.MyPlayerStateChangeListener();
        playbackEventListener = new reportGame.MyPlaybackEventListener();
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.cueVideo("VFX2Nqwwm44"); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportGame.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportGame.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportGame.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportGame.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportGame.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportGame.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportGame.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportGame.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportGame.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
