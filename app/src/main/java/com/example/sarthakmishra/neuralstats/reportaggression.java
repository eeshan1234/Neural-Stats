...
public class reportaggression extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportaggression.MyPlayerStateChangeListener playerStateChangeListener;
    private reportaggression.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportaggression.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportaggression.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportaggression);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0) {
                    Toast.makeText(reportaggression.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
//
...
//                barentries.add(new BarEntry(50f, 7));
                ...
                barentries.add(new BarEntry(aggressionscore, 0));
                barentries.add(new BarEntry(50f, 1));
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(aggressionscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (aggressionscore >= 0 && aggressionscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeAgg(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAgg(0));

                } else if (aggressionscore >= 25 && aggressionscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeAgg(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAgg(1));
                } else if (aggressionscore >= 50 && aggressionscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeAgg(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAgg(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeAgg(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAgg(3));
...
//videos
        ...
        playerStateChangeListener = new reportaggression.MyPlayerStateChangeListener();
        playbackEventListener = new reportaggression.MyPlaybackEventListener();
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.cueVideo("nKd2QVrQVIM"); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportaggression.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportaggression.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportaggression.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportaggression.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportaggression.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportaggression.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportaggression.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportaggression.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportaggression.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
