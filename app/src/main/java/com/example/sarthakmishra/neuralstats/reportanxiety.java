...
public class reportanxiety extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportanxiety.MyPlayerStateChangeListener playerStateChangeListener;
    private reportanxiety.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportanxiety.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportanxiety.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportanxiety);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0) {
                    Toast.makeText(reportanxiety.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }

//                barentries.add(new BarEntry(depressionscore, 0));
//                barentries.add(new BarEntry(50f, 1));

                barentries.add(new BarEntry(anxietyscore, 0));
                barentries.add(new BarEntry(50f, 1));
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(anxietyscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (anxietyscore >= 0 && anxietyscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeAnx(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAnx(0));

                } else if (anxietyscore >= 25 && anxietyscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeAnx(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAnx(1));
                } else if (anxietyscore >= 50 && anxietyscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeAnx(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAnx(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeAnx(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionAnx(3));
...
//videos
        ...
        playerStateChangeListener = new reportanxiety.MyPlayerStateChangeListener();
        playbackEventListener = new reportanxiety.MyPlaybackEventListener();
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.cueVideo("JZ04OcREE2Y"); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportanxiety.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportanxiety.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportanxiety.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportanxiety.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportanxiety.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportanxiety.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportanxiety.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportanxiety.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportanxiety.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
