...
public class reportborderline extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportborderline.MyPlayerStateChangeListener playerStateChangeListener;
    private reportborderline.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportborderline.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportborderline.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportborderline);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0
                    ...
                    Toast.makeText(reportborderline.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//                barentries.add(new BarEntry(50f, 11));
//
//                barentries.add(new BarEntry(toxicscore, 10));
//                barentries.add(new BarEntry(50f, 11));

                barentries.add(new BarEntry(borderlinescore, 0));
                barentries.add(new BarEntry(50f, 1));
                ...
                barDataSet.setColors(new int[]{R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent,
                        R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent
                });
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(borderlinescore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (borderlinescore >= 0 && borderlinescore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeborderline(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionborderline(0));

                } else if (borderlinescore >= 25 && borderlinescore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeborderline(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionborderline(1));
                } else if (borderlinescore >= 50 && borderlinescore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeborderline(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionborderline(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeborderline(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionborderline(3));
...
//videos
        ...
        playerStateChangeListener = new reportborderline.MyPlayerStateChangeListener();
        playbackEventListener = new reportborderline.MyPlaybackEventListener();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportborderline.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportborderline.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportborderline.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportborderline.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportborderline.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportborderline.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportborderline.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportborderline.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportborderline.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
