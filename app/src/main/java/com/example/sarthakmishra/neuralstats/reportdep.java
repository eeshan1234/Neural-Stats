...
public class reportdep extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportdep.MyPlayerStateChangeListener playerStateChangeListener;
    private reportdep.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportdep.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportdep.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportdep);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0) {
                    Toast.makeText(reportdep.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(depressionscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (depressionscore >= 0 && depressionscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeDep(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionDep(0));

                } else if (depressionscore >= 25 && depressionscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeDep(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionDep(1));
                } else if (depressionscore >= 50 && depressionscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeDep(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionDep(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeDep(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionDep(3));
...
//videos
        ...
        playerStateChangeListener = new reportdep.MyPlayerStateChangeListener();
        playbackEventListener = new reportdep.MyPlaybackEventListener();
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.cueVideo("PmEDAzqswh8"); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportdep.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportdep.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportdep.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportdep.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportdep.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportdep.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportdep.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportdep.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportdep.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
