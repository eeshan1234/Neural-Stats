...
public class reportinternet extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportinternet.MyPlayerStateChangeListener playerStateChangeListener;
    private reportinternet.MyPlaybackEventListener playbackEventListener;
    private YouTubePlayer player;
    DecoView arcView;
    TextView view;
    TextView Testtype,Testdescription;
    private float percentage=58;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportinternet.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportinternet.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportinternet);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0) {
                    Toast.makeText(reportinternet.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//                barentries.add(new BarEntry(50f, 3));
                ...
                barentries.add(new BarEntry(internetscore, 0));
                barentries.add(new BarEntry(50f, 1));
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(internetscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (internetscore >= 0 && internetscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeIA(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionIA(0));

                } else if (internetscore >= 25 && internetscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeIA(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionIA(1));
                } else if (internetscore >= 50 && internetscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeIA(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionIA(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeIA(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionIA(3));
...
//videos
        ...
        playerStateChangeListener = new reportinternet.MyPlayerStateChangeListener();
        playbackEventListener = new reportinternet.MyPlaybackEventListener();
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.cueVideo("8UPbdwP4-3Q"); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportinternet.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportinternet.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportinternet.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportinternet.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportinternet.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportinternet.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportinternet.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportinternet.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportinternet.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
