...
public class reportmaleaggress extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportmaleaggress.MyPlayerStateChangeListener playerStateChangeListener;
    private reportmaleaggress.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportmaleaggress.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportmaleaggress.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportmaleaggress);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0
                    ...
                    Toast.makeText(reportmaleaggress.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//                barentries.add(new BarEntry(50f, 11));
                ...
                barentries.add(new BarEntry(maleaggscore, 0));
                barentries.add(new BarEntry(50f, 1));
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(maleaggscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (maleaggscore >= 0 && maleaggscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypemaleagg(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionmaleagg(0));

                } else if (maleaggscore >= 25 && maleaggscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypemaleagg(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionmaleagg(1));
                } else if (maleaggscore >= 50 && maleaggscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypemaleagg(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionmaleagg(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypemaleagg(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionmaleagg(3));
...
//videos
        playerStateChangeListener = new reportmaleaggress.MyPlayerStateChangeListener();
        playbackEventListener = new reportmaleaggress.MyPlaybackEventListener();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportmaleaggress.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportmaleaggress.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportmaleaggress.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportmaleaggress.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportmaleaggress.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportmaleaggress.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportmaleaggress.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportmaleaggress.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportmaleaggress.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
