...
public class reportpanic extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportpanic.MyPlayerStateChangeListener playerStateChangeListener;
    private reportpanic.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportpanic.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportpanic.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportpanic);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0
                    ...
                    Toast.makeText(reportpanic.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//                barentries.add(new BarEntry(50f, 11));
                ...
                barentries.add(new BarEntry(panicscore, 0));
                barentries.add(new BarEntry(50f, 1));
//
...
//                barentries.add(new BarEntry(50f, 11));
                ...
                barDataSet.setColors(new int[]{R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent,
                        R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent,
                        R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent,
                        R.color.white, R.color.colorAccent, R.color.white, R.color.colorAccent
                });
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(panicscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (panicscore >= 0 && panicscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypepanic(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionpanic(0));

                } else if (panicscore >= 25 && panicscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypepanic(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionpanic(1));
                } else if (panicscore >= 50 && panicscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypepanic(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionpanic(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypepanic(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionpanic(3));
...
//videos
        ...
        playerStateChangeListener = new reportpanic.MyPlayerStateChangeListener();
        playbackEventListener = new reportpanic.MyPlaybackEventListener();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportpanic.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportpanic.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportpanic.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportpanic.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportpanic.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportpanic.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportpanic.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportpanic.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportpanic.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
