...
public class reportpsycho extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private reportpsycho.MyPlayerStateChangeListener playerStateChangeListener;
    private reportpsycho.MyPlaybackEventListener playbackEventListener;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent i=new Intent(reportpsycho.this,Homepage.class);
                    startActivity(i);
                    return true;
                ...
                case R.id.navigation_doctor:
                    Intent intent=new Intent(reportpsycho.this,MapsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportpsycho);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (anxietyscore == 0 && aggressionscore == 0 && depressionscore == 0 && Gamescore == 0 && internetscore == 0 && psychosisscore == 0) {
                    Toast.makeText(reportpsycho.this, "You have not taken any test yet!", Toast.LENGTH_SHORT).show();
                }
...
//                barentries.add(new BarEntry(50f, 9));
                ...
                barentries.add(new BarEntry(psychosisscore, 0));
                barentries.add(new BarEntry(50f, 1));
...
//Create data series track
                ...
                arcView.addEvent(new DecoEvent.Builder(psychosisscore).setIndex(series1Index).setDelay(2000).build());
                ...
                if (psychosisscore >= 0 && psychosisscore <= 25) {
                    Testtype.setText(mDescriptionResLibrary.getTypeP(0));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionP(0));

                } else if (psychosisscore >= 25 && psychosisscore <= 50) {
                    Testtype.setText(mDescriptionResLibrary.getTypeP(1));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionP(1));
                } else if (psychosisscore >= 50 && psychosisscore <= 75) {
                    Testtype.setText(mDescriptionResLibrary.getTypeP(2));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionP(2));

                } else {
                    Testtype.setText(mDescriptionResLibrary.getTypeP(3));
                    Testdescription.setText(mDescriptionResLibrary.getDescriptionP(3));
...
//videos
        ...
        playerStateChangeListener = new reportpsycho.MyPlayerStateChangeListener();
        playbackEventListener = new reportpsycho.MyPlaybackEventListener();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==check && resultCode==RESULT_OK)
        {
            ...
            {
                Intent i=new Intent(reportpsycho.this,Predictor.class);
                startActivity(i);

            }
            if(results.contains("doctor"))
            {
                Intent i=new Intent(reportpsycho.this,MapsActivity.class);
                startActivity(i);

            }
            else if(results.contains("about"))
            {
                Intent i=new Intent(reportpsycho.this,about.class);
                startActivity(i);
            }
            ...
            {
                final AlertDialog.Builder builder=new AlertDialog.Builder(reportpsycho.this);
                ...
                builder.setPositiveButton("Exit from app!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(reportpsycho.this,"Signing out...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(reportpsycho.this,"None of the suitable choices matched! Try again with appropriate choices.!",Toast.LENGTH_SHORT).show();
        ...
        mauthStateListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //signout
                    Toast.makeText(reportpsycho.this,"Signed out", Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(reportpsycho.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.contact){
            Toast.makeText(reportpsycho.this,"Now You can write to developers directly!",Toast.LENGTH_LONG).show();
